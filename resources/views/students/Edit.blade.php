...
@if($errors->any())
    <div class="alert alert-danger">
        <strong>Whoopsie!</strong>There were some problems with your input. <br><br>
        <ul>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="studentname" value="{{$student->studentname}}" class="form-control" placeholder="Name">
            </div>
        </div>
